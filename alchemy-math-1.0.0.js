	...
	*/
	...
	A.angleOverlap = function(z1, z2){
		...
		if(A.angleMode() == A.MODE_RAD){
			zone1 = {start: z1.start * A.RAD_TO_DEGREE, end: z1.end * A.RAD_TO_DEGREE};
			zone2 = {start: z2.start * A.RAD_TO_DEGREE, end: z2.end * A.RAD_TO_DEGREE};			
		}
		else{
			zone1 = {start: z1.start, end: z1.end};
			zone2 = {start: z2.start, end: z2.end};
		}
		...
		o = zone1.start > zone2.start && zone1.start < zone2.end
